...
class WebScrapJob:
    ...
    def jobs(self):
        ...
        # VAGA
        self.vaga_page = self.page_soup.findAll ("span", {"id": "ctl00_phMasterPage_cVacancySummary_litVacancyTitle"})
        ...
        # ESTADO
        self.estado_page = self.page_soup.findAll ("span", {"id": "ctl00_phMasterPage_cVacancySummary_litLocation"})
        ...
        self.f.write (self.vaga + "," + self.empresa.replace (",", "|") + "," + self.salario.replace (",",
                                                                                                      "|") + "," + self.data + "," + self.cidade.replace (
            ",", "|") + "," + self.estado + "," + self.url + "\n")
