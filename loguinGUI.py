...
class LoginGUI(tk.Tk):
	...
	def __init__(self,*args, **kwargs):
		...
		label = tk.Label(self, text="Infojobs Apply Bot", font=self.title_font)
...
class StartPage(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		#title
		label = tk.Label(self, text="Vamos fazer o Login", font=controller.subtitle_font)
		label.grid(row=2,columnspan = 2, pady=10)


		#Username and password
		label_username = tk.Label(self, text="Email")
		label_password = tk.Label(self, text="Senha")
		...
		button = tk.Button(self, text="Próximo", command= self.auth)
...
class PageOne(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		#title
		label = tk.Label(self, text="Escolha 3 estados", font=controller.subtitle_font)
		label.grid(row=2,columnspan = 2, pady=10)

		#language
		self.var = tk.StringVar()
		R1 = tk.Radiobutton(self, text="São Paulo", variable=self.var, value="en")#,command=self.sel)
		R1.grid(row=4, column=0, sticky = "W")

		R2 = tk.Radiobutton(self, text="Paraná", variable=self.var, value="es")#,command=self.sel)
		R2.grid(row=5,column=0, sticky = "W")

		R3 = tk.Radiobutton(self, text="Santa Catarina", variable=self.var, value="pt")#,command=self.sel)
		R3.grid(row=6,column=0, sticky = "W")

		self.var.set("en")

		#button
		button = tk.Button(self, text="Próximo",command=self.sel)
		button.grid(row=7, columnspan=2, pady=30)
...
class PageTwo(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		#title
		label = tk.Label(self, text="Digite o cargo \n (Exemplo. Analista de dados, Doméstica)", font=controller.subtitle_font)
		label.grid(row=2,columnspan = 2, pady=10)
		...
		#button
		button = tk.Button(self, text="Próximo",command= self.sel_position)
		button.grid(row=7, columnspan=2, pady=30)
...
class PageThree(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		#title
		label = tk.Label(self, text="Em quais estados do Brasil?", font=controller.subtitle_font)
		label.grid(row=2,columnspan = 2, pady=10)

		#Location
		self.var = tk.IntVar()
		R1 = tk.Radiobutton(self, text="São Paulo", variable=self.var, value=1)#,command=self.sel_location_code)
		R1.grid(row=3, column=0, sticky = "W")

		R2 = tk.Radiobutton(self, text="Paraná", variable=self.var, value=2)#,command=self.sel_location_code)
		R2.grid(row=4,column=0, sticky = "W")

		R3 = tk.Radiobutton(self, text="Santa Catarina", variable=self.var, value=3)#,command=self.sel_location_code)
		R3.grid(row=5,column=0, sticky = "W")

		R4 = tk.Radiobutton(self, text="Minas Gerais", variable=self.var, value=4)#,command=self.sel_location_code)
		...
		button = tk.Button(self, text="Próximo",command= self.sel_location_code)
		button.grid(row=7, columnspan=2, pady=30)
...
class PageFour(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		#type position
		label_location = tk.Label(self, text="Quais cidades?")
		...
		button = tk.Button(self, text="Próximo",command= self.sel_location)
		button.grid(row=7, columnspan=2, pady=30)
...
class PageSix(tk.Frame):
	...
	def summary (self):
		label = tk.Label(self, text="Podemos começar?", font=self.controller.subtitle_font)
		label.grid(row=2,columnspan = 2, pady=10)

		#button1 = tk.Button(self, text="Next", command=lambda: controller.show_frame("PageOne"))
		button = tk.Button(self, text="Vamos Lá!",command=self.finish)
		button.grid(row=7, columnspan=2, pady=30)
